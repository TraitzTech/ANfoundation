        ...
        >
          <ul className="varpillar-gen-ul">
            ...
            >
              ...
              <li className="dd-lv-1-1-li-one">&#8226; Secondary Education</li>
              <li className="dd-lv-1-1-li-two">&#8226; Higher Education</li>
              <li className="dd-lv-1-1-li-three">&#8226; Agriculture</li>
              <li className="dd-lv-1-1-li-four">&#8226; Business and Trades</li>
              <li className="dd-lv-1-1-li-five">&#8226; Capentry</li>
              <li className="dd-lv-1-1-li-six">&#8226; Wielding</li>
              <li className="dd-lv-1-1-li-seven">&#8226; Solar Electrification</li>
              <li className="dd-lv-1-1-li-eight">&#8226; Tailoring</li>
