    ...
    <div className="aboutevent-container">
      ...
      <div className="aboutevent-container-contents">
        ...
        <p>
          ...
          University of Bamenda are key landmarks within the town. Like many
          areas in the North West, Bambili has been affected by the ongoing
          conflict, leading to insecurity, displacement, and humanitarian
          concerns. Despite these challenges, Bambili's rich cultural heritage
          and resilient community offer hope for a brighter future.
        </p>
      </div>
