    ...
    <div className="aboutevent-container">
      ...
      <div className="aboutevent-container-contents">
        ...
        <p>
          ...
          It is home to approximately 32,000 inhabitants.The University of
          Bamenda (in Bambili) and Lake Bambili are key landmarks within the
          town, the former drawing many youth from across the country. Like many
          parts of the North West Region, Bambili has been affected by the
          ongoing {""}
          <a
            style={{ color: "orange" }}
